...
</svg></a>. I've lightly learned Unity, but for my purpose, I need something lightweight and open. The player will be able to modify and build their spaceship, explore our solar system at 'real scale', make allies, and fight foes in a realistic physics simulation. The goal is to show the grueling nature of space travel - and combat, while also. Godot seems to make multiplayer a realistic eventual feature, and given the 
...
<span className="px-3"></span>My interests are pretty broad, but usually technical. I am a long-time 3d printing enthusiast, I own 3 printers, and one of my jobs involved maintaining a fleet. I'm facinated by control systems, since a rocketry challenge in highschool I've iterated on my own flight control code, sometime to publish an open source drone. 
`
