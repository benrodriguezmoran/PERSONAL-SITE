      ...
      <Container>
          ...
          <Row className='row-cols-lg-2 row-cols-1 py-3 my-3 border-bottom d-flex' >
            <Col className='text-light lh-lg d-flex order-lg-1  align-items-center'>
              <div>
                ...
                <Link className='col p-0 link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover' to="/portfolio/spacegame">
                  here</Link>, or my other projects on my <Link className='col p-0 link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover' to="/portfolio">portfolio</Link>.
              </div> 
        ...
        <Row className='p-0 row-cols-lg-2 row-cols-1 py-3 my-3 border-bottom d-flex align-items-center' > 
            <Col className='text-light lh-lg'>
              ...
              <Markdown rehypePlugins={[rehypeRaw]}>
                {about3()}
              </Markdown> Feel free to <Link className='col p-0 link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover' to="/gallery">contact me
              </Link> to inquire reguarding software or web design opportunities.
              </div>
            </Col>
